...
document.addEventListener("click", (e)=>{
    ...
    newPositionX = Math.max(0, Math.min(newPositionX, wall.clientWidth - spider.offsetWidth));
    newPositionY = Math.max(0, Math.min(newPositionY, wall.clientHeight - spider.offsetHeight));
